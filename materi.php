...
<div id="loading-icon-bx"></div>
    ...
    <div class="page-content bg-white">
        <!-- inner page banner -->
        <div class="page-banner ovbl-dark" style="height:200px;background-image:url(assets/images/banner/banner3.jpg);">
            <div class="container">
		...
		<div class="row">
			<div class="col-lg-9 col-md-8 col-sm-12">
				<!-- About Us -->
				<embed src="materi/ppp-bab1.pdf" width="100%" height="600px" />
			</div>

			<div class="col-lg-3 col-md-4 col-sm-12 mt-4 mb-4" style="overflow-y: auto;">
				<h1>Komentar</h1>
				...
				<div class="container">
					<form name="message" action="">
						<div class="panel-footer mr-3 mt-3">
